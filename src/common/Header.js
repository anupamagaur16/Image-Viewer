    ...
    render() {
        ...
        <div className='header'>
            <span className="header-text">
                {this.props.iconDisplay==="dispNone"?
                <span>
                    {this.props.heading}
                </span>:
                <span onClick={this.props.homeredirect}>
                    {this.props.heading}
                </span>}
            </span>
            ...
            <div className={this.props.iconDisplay}>
                <div className="image">
                    <Avatar aria-controls="simple-menu" aria-haspopup="true" onClick={this.openMenuHandler} src={this.state.ownerInfo_self.profile_picture} alt="profile-icon"></Avatar>
                    <div >
                        <Menu 
                        id="simple-menu"
                        keepMounted
                        ...
                        anchorPosition={{ top: 62, left:2000}}>
                            ...
                            <span> 
                                <MenuItem onClick={this.props.profileredirect}>My Account</MenuItem><hr className="menuRule"/>
                            </span>:""}
